...
cd "/home/alfred/quan_ws/src/audio_common/sound_play"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/alfred/quan_ws/src/audio_common/sound_play/setup.py" \
    build --build-base "/home/alfred/quan_ws/build/audio_common/sound_play" \
    install \
    $DESTDIR_ARG \
