...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/alfred/quan_ws/src/gscam)
  set(gscam_DEVEL_PREFIX /home/alfred/quan_ws/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/alfred/quan_ws/install)
...
if(NOT "/home/alfred/quan_ws/src/gscam/include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include;/usr/include/libxml2" STREQUAL "")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/alfred/quan_ws/src/gscam/include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include;/usr/include/libxml2")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alfred/quan_ws/src/gscam/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()
    _list_append_unique(gscam_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gscam;gstapp-0.10;gstbase-0.10;gstreamer-0.10;gobject-2.0;gmodule-2.0;gthread-2.0;rt;xml2;glib-2.0")
